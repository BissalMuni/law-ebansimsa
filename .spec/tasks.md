...
- [x] [T027] 개정 모드 기존 조례 로드 모달(업로드/검색/붙여넣기) (US6) (`web/src/components/LoadOrdinanceModal.tsx`)
- [x] [T028] Monaco DiffEditor + 조 단위 정렬(jsdiff) + 변경 카운트 (`web/src/components/DiffView.tsx`)
