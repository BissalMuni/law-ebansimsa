"""조례안을 개별 조문으로 분리하는 모듈"""

from __future__ import annotations

import re
from .models import Article, DOCUMENT_ID
...
def split_ordinance(text: str) -> list[Article]:
    ...
    Returns:
        Article 리스트 (__DOCUMENT__ + 개별 조문)
    """
    ...
    if addendum:
        ...
        addendum_end = appendix.start() if appendix and appendix.start() > addendum_start else len(text)
